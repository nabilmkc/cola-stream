...
def is_stream_url(url) -> bool:
    ...
    URL thuộc domain trang web nguồn (colatv99.live, colatv65.live...) chỉ được
    ...
    for blv_name, urls in match["blvs_dict"].items():
        for idx, s_url in enumerate(urls):
            ...
            stream_links.append({
                ...
                "url": s_url,
                "request_headers": [
                    {"key": "Referer", "value": "https://colatv99.live/"},
...
def main():
    ...
    print("Lay & gom nhom tran dau tu colaTV API...")
    ...
    output = {
        "id": "colatv", "url": "hhttps://colatv99.live", "name": "colaTV",
        "color": "#0155a5", "grid_number": 3,
        "image": {"type": "cover", "url": "https://colatv99.live/assets/images/logo.png"},
        "groups": groups,
    }
